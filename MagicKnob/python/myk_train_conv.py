...
def train_epoch(model : myk_models_conv.SimpleLSTM,#torch.nn.Module, 
...
def train_epoch_interval(model : myk_models_conv.SimpleLSTM,#torch.nn.Module, 
                dataloader : DataLoader,  
                loss_functions, 
                optimiser, 
                device='cpu',
...
def train_epoch_conv(model : myk_models_conv.SimpleConv2D,#torch.nn.Module, 
                dataloader : DataLoader,  
                loss_functions, 
                optimiser, 
                device='cpu',
